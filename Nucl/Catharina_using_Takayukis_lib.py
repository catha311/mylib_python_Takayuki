...
# or       k = [0,0,0,-1,-1] # n=0, l=0, m=0, s=-1/2, proton
nucleon1i = [n1i,l1i,m1i,s1i,t1i] = [0, 0, 0, 1, -1] # nucleon 1i
nucleon1f = [n1f,l1f,m1f,s1f,t1f] = [0, 0, 0, 1, -1] # nucleon 1f
nucleon2i = [n2i,l2i,m2i,s2i,t2i] = [0, 0, 0, -1, 1]  # nucleon 2i
nucleon2f = [n2f,l2f,m2f,s2f,t2f] = [0, 0, 0, -1, 1]  # nucleon 2f
...
def createfilesfunc(diagram,nucl1i,nucl1f,nucl2i,nucl2f,itoverin):
    for r in itoverin: 
        ...
        # n2i,l2i,m2i,s2i,t2i = nucl2i # nucleon 2i
        # n2f,l2f,m2f,s2f,t2f = nucl2f # nucleon 2f 
        # qnumbers="_s1is1fs2is2f"+str(s1i)+str(s1f)+str(s2i)+str(s2f)+"_n1il1im1i-"+str(n1i)+str(l1i)+str(m1i)+"_n1fl1fm1f-"+str(n1f)+str(l1f)+str(m1f)+"_n2il2im2i-"+str(n2i)+str(l2i)+str(m2i)+"_n2fl2fm2f-"+str(n2f)+str(l2f)+str(m2f)
        ######### filename before Q
        ...
        print("n1i, l1i, m1i, s1i, t1i=",nucl1i, file=file_save)
        print("n1f, l1f, m1f, s1f, t1f=",nucl1f, file=file_save)
        print("n2i, l2i, m2i, s2i, t2i=",nucl2i, file=file_save)
